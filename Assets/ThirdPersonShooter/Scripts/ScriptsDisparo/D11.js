...
S.CV.Destello[1].SetActive(false);
...
Cargador -= 1;
SistemaCarga += 1;
S.CV.Destello[1].SetActive(true);
...
if(Cargador == 0 && MunicionTotal == 0 && S.CSD.d11b == true){
S.CV.BloqueoDelDisparo2 = false;
}else if(Cargador != 0 && MunicionTotal != 0 && S.CSD.d11b == true){
